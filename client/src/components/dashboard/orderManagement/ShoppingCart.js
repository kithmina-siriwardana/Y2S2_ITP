...
export default function ShoppingCart() {
  ...
  useEffect(() => {
    Axios.get(`http://localhost:5000/api/v5/Cart/getAll/${customer_id}`).then(
      (getData) => {
  ...
  const onDelete = (id) => {
    axios
      .delete(`http://localhost:5000/api/v5/Cart/delete/${id}/${customer_id}`)
      .then(() => {
                      ...
                      return (
                        <tr>
                          ...
                          <td class="cart-product-quantity">
                            <div class="cart-plus-minus">{data.quantity}</div>
                          </td>
                          <td class="cart-product-subtotal">
                            Rs.{data.quantity * data.unit_price}
                          </td>
                        </tr>
                      );
                    })}
                ...
                <table class="table">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <strong>Rs.{totalCartPrice + 450}</strong>
                      </td>
                    </tr>
                  </tbody>
                </table>
