...
function SupplierPaymentForm(props) {
  ...
  useEffect(() => {
    Axios.get(
      `http://localhost:5000/api/supplier-payment/getOne/${historyID}`
    ).then((getData) => {
              ...
              <form className="row g-3">
                ...
                <div className="col-md-4">
                  ...
                  <input
                    ...
                    className="form-control"
                    id="rawMaterial"
                    value={historyData.paymentReferenceNo}
                    required
                    disabled
                    readOnly
                  />
                ...
                <div id="imgID">
                  <img
                    src={require(`./uploadedRecipt/${file}`)}
                    style={{ width: "50%" }}
                    alt="natho"
                  />
                </div>
