...
function SupplierPayment() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:5000/api/v9/supplierOrder/unpaid/`)
      .then((getData) => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:5000/api/supplier-payment/`).then((getData) => {
                        ...
                        {apiData.map((data) => {
                          return (
                            <tr>
                              ...
                              <Link
                                to={{
                                  pathname: `/SupplierPaymentForm/${data._id}/${data.supplierId}`,
                                }}
                              >
                                <button
                                  type="button"
                          ...
                          return (
                            <tr>
                              ...
                              <td>
                                <Link
                                  to={{
                                    pathname: `/viewSupplierPayment/${data.orderID}/${data.supplierID}/${data._id}/${data.transactionDate}/${data.fileName}`,
                                  }}
                                >
