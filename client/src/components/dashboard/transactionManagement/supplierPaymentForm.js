...
function SupplierPaymentForm(props) {
  ...
  useEffect(() => {
    ...
    Axios.get(`http://localhost:5000/api/suppliers/${supplierID}`).then(
      (getData) => {
  ...
  useEffect(() => {
    Axios.get(`http://localhost:5000/api/v9/supplierOrder/${orderID}`).then(
      (getData) => {
  ...
  const sendDataToAPI = async (e) => {
    ...
    if (isValid) {
      ...
      await Axios.put(
        `http://localhost:5000/api/v9/supplierOrder/suporderupdate/${orderID}`,
        {
          supplierId,
          rawMaterial,
          quantity,
              ...
              <form className="row g-3">
                ...
                <div className="col-md-4">
                  ...
                  <input
                    ...
                    className="form-control"
                    id="rawMaterial"
                    value={supData.contactPersonName}
                    required
                    disabled
                    readOnly
                  />
                ...
                <div className="col-md-4">
                  ...
                  <input
                    ...
                    className="form-control"
                    id="rawMaterial"
                    value={supData.contactPersonEmail}
                    required
                    disabled
                    readOnly
                  />
                ...
                <div className="col-md-4">
                  ...
                  <label htmlFor="ReceiverBankAccountNo" className="form-label">
                    {Object.keys(amountERR).map((key) => {
                      return (
                        <div style={{ color: "red" }}>{amountERR[key]}</div>
                      );
                    })}
                  </label>
                </div>
