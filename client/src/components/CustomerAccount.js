...
function CustomerAccount() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:5000/api/v3/payment/getPayment/${user.id}`)
      .then((getData) => {
  ...
  const onDelete = (e) => {
    ...
    axios
      .delete(`http://localhost:5000/api/v3/payment/removePayment/${user.id}`)
      .then(() => {});
  ...
  const sendDataToAPI = (e) => {
    ...
    if (isValid) {
      axios.put(
        `http://localhost:5000/api/v3/payment/updatePayment/${user.id}`,
        {
          number,
          Hname,
          expiry,
                              ...
                              <div class="col-md-6 col-10 learts-mb-30">
                                ...
                                >
                                  <h4 class="alert-heading">
                                    Payments details Requset
                                  </h4>
                                  <p style={{ marginBottom: "20%" }}>
                                    Please enter the payment details.It will be
                                    used on the checkout page by default
                                  </p>
                                  <hr />
                                  <p class="mb-0">
                                    Press below "Add card details" button to add
                                    payment details
                                  </p>
                                  <br />
                                  ...
                                  <div className="col-md-6">
                                    ...
                                    <div className="form-floating">
                                      ...
                                      >
                                        ...
                                        {Object.keys(expireDateERR2).map(
                                          (key) => {
                                            return (
                                              <div style={{ color: "red" }}>
                                                {expireDateERR2[key]}
                              ...
                              <div class="row mb-50">
                                <div class="col-md-12">
                                  ...
                                  <textarea
                                    ...
                                    name="ltn__email"
                                    onChange={(e) =>
                                      setSiteFeedback(e.target.value)
                                    }
                                    value={sFeedback}
                                  ></textarea>
                                </div>
